      ...
      <div className="w-full md:py-20">
        <Wrapper>
          <div className="flex-[2] flex flex-col items-center pb-[50px] md:mt-14">
            ...
            {/* Add a Link to redirect to the product listing or homepage */}
            <Link href="/">
      ...
      <div className="w-full md:py-20">
        <Wrapper>
          <div className="text-center max-w-[800px] mx-auto mt-5 md:mt-0">
            <div className="text-[28px] md:text-[30px]  font-bold leading-tight text-center max-w-[800px] mx-auto mt-8 md:mt-0 mb-4">
              Shopping Cart
            </div>
          </div>
          <div className="flex flex-col lg:flex-row gap-12 ">
            ...
            <div className="flex-[1]">
              ...
              <Link href="/payment">
                <button
                  className="w-full py-2 rounded-full bg-indigo-600 text-white text-md font-medium transition-transform active:scale-95 mb-3 flex items-center gap-2 justify-center
